...
import { validateMutateUser } from "../../../middleware/validation.js";

const router = express.Router();

// Run createUser on any POST request made to the /users route.
router.post("/", validateMutateUser, createUser);
...
router.put("/:id", validateMutateUser, updateUser);
// Run deleteUser whenever a DELETE request is made to /users with the 'id' parameter.
router.delete("/:id", validateMutateUser, deleteUser);
