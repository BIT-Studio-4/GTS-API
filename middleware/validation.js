...
import { createUserSchema, updateUserSchema, createItemSchema, updateItemSchema, createSaveGameSchema } from "./validationSchemas.js";
...
/**
 * @description Validate any route that creates an item, e.g., /api/items.
 * @param {*} req The request body including the headers and body sent by the client.
 * @param {*} res The response to be generated by the server after receiving the request.
 * @param {*} next The next step in the request chain, e.g, handling the request in the controllers.
 */
...
/**
 * @description Validate any route that creates a game save, e.g., /api/save_games.
 * @param {*} req The request body including the headers and body sent by the client.
 * @param {*} res The response to be generated by the server after receiving the request.
 * @param {*} next The next step in the request chain, e.g, handling the request in the controllers.
 */
const validateCreateSaveGame = (req, res, next) => {
  const { error } = createSaveGameSchema.validate(req.body);
